...
export const AFFINITY_MAX_LOGICAL_REQUESTS = positiveEnv("AFFINITY_MAX_LOGICAL_REQUESTS", 30, true); // ponytail: fixed ceiling; per-combo tuning would need settings plumbing
