...
export default function MediaProviderDetailPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Provider Info — config-driven, supports searchConfig, fetchConfig, ttsConfig, embeddingConfig, decisionsConfig, searchViaChat */}
      {!isCustom && (provider.searchConfig || provider.fetchConfig || provider.ttsConfig || provider.sttConfig || provider.embeddingConfig || provider.decisionsConfig || provider.searchViaChat) && (
        <ProviderInfoCard
          config={
            kind === "webFetch" ? provider.fetchConfig
              ...
              : kind === "decisions" ? provider.decisionsConfig
