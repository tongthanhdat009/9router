// Standalone HTTPS SSE upstream for interference isolation (prints port on stdout).
import fs from "node:fs";
import https from "node:https";

const [, , keyFile, certFile] = process.argv;
if (!keyFile || !certFile) { process.stderr.write("usage: upstream-child.mjs <key> <cert>\n"); process.exit(2); }
