export default {
  ...
  models: [
    ...
    // v4.1-flash rejects the native Claude wire format upstream (400 {"model":...});
    // declare openai-only so chatCore translates Claude-shape requests via /chat/completions.
