...
export const PROVIDER_CAPABILITIES = {
  ...
  "codebuddy-cn": {
    ...
    "kimi-k3-1":          { reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1000000, maxOutput: 32000 },
    ...
    // deepseek-v4.1-flash replaces v4-flash upstream (dropped from the server list;
    ...
    "deepseek-v4.1-flash": { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1000000, maxOutput: 128000 },
...
export const PATTERN_CAPABILITIES = [
  ...
  { pattern: "*gpt-6*image*",   caps: { imageOutput: true } },
